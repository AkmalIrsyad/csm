...
class MenuHelper
{
    ...
    public static function getMasterGroupItems()
    {
        return [
            [
                'name' => 'General',
                'icon' => 'pages',
                'subItems' => [
                    ['name' => 'Currency', 'path' => '/csm-admin/master/general/currency', 'pro' => false],
                    ['name' => 'Branch', 'path' => '/csm-admin/master/general/branch', 'pro' => false],
                    ['name' => 'Bank', 'path' => '/csm-admin/master/general/bank', 'pro' => false],
                    ['name' => 'Class Of Business', 'path' => '/csm-admin/master/general/class-of-business', 'pro' => false],
                    ['name' => 'Business', 'path' => '/csm-admin/master/general/business', 'pro' => false],
                    ['name' => 'Memorial Code List', 'path' => '/csm-admin/master/general/memorial-code-list', 'pro' => false],
                    ['name' => 'Segment', 'path' => '/csm-admin/master/general/segment', 'pro' => false],
                    ['name' => 'Chart Of Account', 'path' => '/csm-admin/master/general/chart-of-account', 'pro' => false],
                    ['name' => 'Journal Template', 'path' => '/csm-admin/master/general/journal-template', 'pro' => false],
                ],
            ],
            [
                'name' => 'Liability',
                'icon' => 'tables',
                'subItems' => [
                    ['name' => 'Portfolio and Assumption', 'path' => '/csm-admin/master/liability/portfolio-and-assumption', 'pro' => false],
                    ['name' => 'Discount Rate And Liquidity Premium', 'path' => '/csm-admin/master/liability/discount-rate-and-liquidity-premium', 'pro' => false],
                    ['name' => 'Lapse Ratio', 'path' => '/csm-admin/master/liability/lapse-ratio', 'pro' => false],
                    ['name' => 'Opex Allocation', 'path' => '/csm-admin/master/liability/opex-allocation', 'pro' => false],
                    ['name' => 'Accident Rate', 'path' => '/csm-admin/master/liability/accident-rate', 'pro' => false],
                    ['name' => 'Inflation Rate', 'path' => '/csm-admin/master/liability/inflation-rate', 'pro' => false],
                    ['name' => 'NPR rate', 'path' => '/csm-admin/master/liability/npr-rate', 'pro' => false],
                    ['name' => 'Risk Value Matrix', 'path' => '/csm-admin/master/liability/risk-value-matrix', 'pro' => false],
                ],
            ],
        ];
    }

    public static function getDataManagementGroupItems()
    {
        return [
            [
                'name' => 'Tools',
                'icon' => 'ui-elements',
                'subItems' => [
                    ['name' => 'Data Quality Control', 'path' => '/csm-admin/data-management/tools/data-quality-control', 'pro' => false],
                    ['name' => 'Journal Export', 'path' => '/csm-admin/data-management/tools/journal-export', 'pro' => false],
                    ['name' => 'COA Mapping', 'path' => '/csm-admin/data-management/tools/coa-mapping', 'pro' => false],
                    ['name' => 'Memorial Exclusion', 'path' => '/csm-admin/data-management/tools/memorial-exclusion', 'pro' => false],
                ],
            ],
            [
                'name' => 'Template Data Migration',
                'icon' => 'forms',
                'path' => '/csm-admin/data-management/template-data-migration',
            ],
            [
                'name' => 'Data Staging',
                'icon' => 'dashboard',
                'path' => '/csm-admin/data-management/data-staging',
            ],
        ];
    }

    public static function getReportGroupItems()
    {
        return [
            [
                'name' => 'Subledger Report',
                'icon' => 'charts',
                'subItems' => [
                    ['name' => 'Insurance Contract Production Report', 'path' => '/csm-admin/report/subledger/insurance-contract-production-report'],
                    ['name' => 'Insurance Contract Receipt', 'path' => '/csm-admin/report/subledger/insurance-contract-receipt'],
                    ['name' => 'Insurance Service Expense - Incurred Claims Report', 'path' => '/csm-admin/report/subledger/insurance-service-expense-incurred-claims-report'],
                    ['name' => 'Insurance Service Expense - Claim Payment', 'path' => '/csm-admin/report/subledger/insurance-service-expense-claim-payment'],
                    ['name' => 'Reinsurance Contract Production', 'path' => '/csm-admin/report/subledger/reinsurance-contract-production'],
                    ['name' => 'Reins Contract Payment Report', 'path' => '/csm-admin/report/subledger/reins-contract-payment-report'],
                    ['name' => 'Incurred Claim Ceded To Reinsurer', 'path' => '/csm-admin/report/subledger/incurred-claim-ceded-to-reinsurer'],
                    ['name' => 'Incurred Claim Ceded To Reinsurer Receipt', 'path' => '/csm-admin/report/subledger/incurred-claim-ceded-to-reinsurer-receipt'],
                    ['name' => 'Outstanding Claim', 'path' => '/csm-admin/report/subledger/outstanding-claim'],
                ],
            ],
            [
                ...
                'icon' => 'tables',
                'subItems' => [
                    ['name' => 'Chart of Account', 'path' => '/csm-admin/report/financial/chart-of-account'],
                    ['name' => 'Journal Template Report', 'path' => '/csm-admin/report/financial/journal-template-report'],
                    ['name' => 'Transaction Journal', 'path' => '/csm-admin/report/financial/transaction-journal'],
                    ['name' => 'Trial Balance', 'path' => '/csm-admin/report/financial/trial-balance'],
                    ['name' => 'General Ledger', 'path' => '/csm-admin/report/financial/general-ledger'],
                    ['name' => 'Statements of Financial Position', 'path' => '/csm-admin/report/financial/statements-of-financial-position'],
                    ['name' => 'Statements of Profit or Loss', 'path' => '/csm-admin/report/financial/statements-of-profit-or-loss'],
                    ['name' => 'Profit or Loss per Portfolio', 'path' => '/csm-admin/report/financial/profit-or-loss-per-portfolio'],
                    ['name' => 'OPEX Report', 'path' => '/csm-admin/report/financial/opex-report'],
                    ['name' => 'Admin Fee', 'path' => '/csm-admin/report/financial/admin-fee'],
                ],
            ],
            [
                'name' => 'Actuary Report',
                'icon' => 'email',
                'subItems' => [
                    ['name' => 'Portfolio Report', 'path' => '/csm-admin/report/actuary/portfolio-report'],
                    ['name' => 'IBNR Report', 'path' => '/csm-admin/report/actuary/ibnr-report'],
                    ['name' => 'LRC PAA Report', 'path' => '/csm-admin/report/actuary/lrc-paa-report'],
                    ['name' => 'LRC PAA Yearly Report', 'path' => '/csm-admin/report/actuary/lrc-paa-yearly-report'],
                    ['name' => 'LRC PAA Insurance GPW DAC Report', 'path' => '/csm-admin/report/actuary/lrc-paa-insurance-gpw-dac-report'],
                    ['name' => 'LRC PAA Ceded to RI Report', 'path' => '/csm-admin/report/actuary/lrc-paa-ceded-to-ri-report'],
                    ['name' => 'LRC PAA Yearly Ceded to RI Report', 'path' => '/csm-admin/report/actuary/lrc-paa-yearly-ceded-to-ri-report'],
                    ['name' => 'LRC GMM Report', 'path' => '/csm-admin/report/actuary/lrc-gmm-report'],
                    ['name' => 'LRC GMM Yearly Report', 'path' => '/csm-admin/report/actuary/lrc-gmm-yearly-report'],
                    ['name' => 'LRC GMM Ceded to RI Engine Report', 'path' => '/csm-admin/report/actuary/lrc-gmm-ceded-to-ri-engine-report'],
                    ['name' => 'LRC GMM Reins Yearly Report', 'path' => '/csm-admin/report/actuary/lrc-gmm-reins-yearly-report'],
                    ['name' => 'OPEX Allocation Report', 'path' => '/csm-admin/report/actuary/opex-allocation-report'],
                    ['name' => 'Profit Loss per Policy Report', 'path' => '/csm-admin/report/actuary/profit-loss-per-policy-report'],
                    ['name' => 'LRC Movement Analysis', 'path' => '/csm-admin/report/actuary/lrc-movement-analysis'],
                ],
            ],
            [
                'name' => 'Disclosure',
                'icon' => 'pages',
                'subItems' => [
                    ['name' => 'Disclosure EFCF Receivable', 'path' => '/csm-admin/report/disclosure/disclosure-efcf-receivable'],
                    ['name' => 'Disclosure Acquisition Cost', 'path' => '/csm-admin/report/disclosure/disclosure-acquisition-cost'],
                    ['name' => 'Disclosure EFCF Payable', 'path' => '/csm-admin/report/disclosure/disclosure-efcf-payable'],
                    ['name' => 'Disclosure Incurred Claims', 'path' => '/csm-admin/report/disclosure/disclosure-incurred-claims'],
                    ['name' => 'Disclosure COA to Payable And Receivable', 'path' => '/csm-admin/report/disclosure/disclosure-coa-to-payable-and-receivable'],
                    ['name' => 'Disclosure LRC PAA', 'path' => '/csm-admin/report/disclosure/disclosure-lrc-paa'],
                    ['name' => 'Disclosure LRC GMM', 'path' => '/csm-admin/report/disclosure/disclosure-lrc-gmm'],
                    ['name' => 'Disclosure LIC', 'path' => '/csm-admin/report/disclosure/disclosure-lic'],
                ],
            ],
            [
                ...
                'icon' => 'task',
                'subItems' => [
                    ['name' => 'OJK Report', 'path' => '/csm-admin/report/regulatory/ojk-report'],
                    ['name' => 'Template Mapping', 'path' => '/csm-admin/report/regulatory/template-mapping'],
                    ['name' => 'Results of Insurance Services', 'path' => '/csm-admin/report/regulatory/results-of-insurance-services'],
                    ['name' => 'Total Sum Insured', 'path' => '/csm-admin/report/regulatory/total-sum-insured'],
                    ['name' => 'LRC Amortization Period', 'path' => '/csm-admin/report/regulatory/lrc-amortization-period'],
                    ['name' => 'Reinsurance Contract Held', 'path' => '/csm-admin/report/regulatory/reinsurance-contract-held'],
                    ['name' => 'Csm Roll Forward Report', 'path' => '/csm-admin/report/regulatory/csm-roll-forward-report'],
                ],
            ],
        ];
    }
    ...
    public static function getMenuGroups()
    {
        ...
        if (auth()->check() && auth()->user()->hasRole('CSM Administrator')) {
            array_splice($groups, 1, 0, [
                [
                    'title' => 'Master',
                    'items' => self::getMasterGroupItems()
                ],
                [
                    'title' => 'Data Management',
                    'items' => self::getDataManagementGroupItems()
                ],
                [
                    'title' => 'Report',
                    'items' => self::getReportGroupItems()
                ]
            ]);
        }
