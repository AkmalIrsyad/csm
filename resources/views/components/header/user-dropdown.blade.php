<div class="relative" x-data="{
    ...
    >
       ...
       <span class="block mr-1 font-medium text-theme-sm">{{ Auth::user() ? Auth::user()->name : 'Guest' }}</span>
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ Auth::user() ? Auth::user()->name : 'Guest' }}</span>
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{{ Auth::user() ? Auth::user()->email : 'guest@example.com' }}</span>
        </div>
